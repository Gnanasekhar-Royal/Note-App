...
import 'package:noteapp2/note_with_bloc/bloc_descriptionpage.dart';
import 'package:noteapp2/note_with_bloc/bloc_newnote.dart';
...
class _BlocHomeState extends State<BlocHome> {
  ...
  void getallnotes(){
BlocProvider.of<NoteBloc>(context).add(fetchNote());
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => BlocNewnote()));
        },
        child: Icon(
          Icons.add,
          color: Colors.white,
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => BlocDescriptionpage(title,desc,date)));
                                        ...
                                        children: [
                                          OutlinedButton(onPressed: (){
                                           // Provider.of<NoteProvider>(context).updateNote(notetitlecontroller.text, notedesccontroller.text, notedatecontroller.text, columnid)
                                            ...
                                            BlocProvider.of<NoteBloc>(context).add(updateNote(notetitlecontroller.text, notedesccontroller.text, notedatecontroller.text,columnid));
                            ...
                            return AlertDialog(
                              ...
                              actions: [
                                ...
                                TextButton(onPressed: (){
                                  ...
                                  BlocProvider.of<NoteBloc>(context).add(delNote(columnid));
                                  // Navigator.pop(context);
